...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { contact: @instructor.contact, link: @instructor.link, name: @instructor.name, project_id: @instructor.project_id } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { contact: @instructor.contact, link: @instructor.link, name: @instructor.name, project_id: @instructor.project_id } }
