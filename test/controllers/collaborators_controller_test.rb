...
class CollaboratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collaborator" do
    assert_difference('Collaborator.count') do
      post collaborators_url, params: { collaborator: { contact: @collaborator.contact, link: @collaborator.link, name: @collaborator.name, project_id: @collaborator.project_id } }
    end
  ...
  test "should update collaborator" do
    patch collaborator_url(@collaborator), params: { collaborator: { contact: @collaborator.contact, link: @collaborator.link, name: @collaborator.name, project_id: @collaborator.project_id } }
